...
export function ParentFeePage() {
  ...
  const invoices = selectedChildId 
    ? allInvoices?.filter(inv => inv.student_id === selectedChildId)
    : allInvoices;
  ...
  return (
    <div className="p-4 md:p-6 pb-20 lg:pb-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View fee invoices for your children</p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">
                  {selectedChildId ? `Viewing: ${selectedChild?.student?.profile?.full_name || 'Child'}` : 'Viewing all children'}
                </span>
              </div>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" size="sm">
                    {selectedChildId ? 'Change Child' : 'Filter by Child'}
